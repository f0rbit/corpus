...
<div class="grid">
  <div class="card">
    ...
    <div class="card-description">Fast in-memory storage for testing and prototyping</div>
  </div>
  <div class="card">
    <div class="card-title">File</div>
    <div class="card-description">Local filesystem storage using Bun's file APIs</div>
  </div>
  <div class="card">
    <div class="card-title">Cloudflare</div>
    <div class="card-description">Production-ready D1 + R2 for global distribution</div>
  </div>
  <div class="card">
    <div class="card-title">Layered</div>
    <div class="card-description">Combine backends for caching and replication</div>
  </div>
</div>
...
<a href="/corpus/guides/cloudflare/" class="card card-interactive">
  <div class="card-title">Cloudflare Deployment Guide</div>
  <div class="card-description">Step-by-step setup instructions for D1 and R2</div>
</a>
...
<Tabs defaultValue="caching" client:load>
<TabList client:load>
<Tab value="caching" client:load>Caching</Tab>
<Tab value="migration" client:load>Migration</Tab>
<Tab value="replication" client:load>Replication</Tab>
</TabList>
<TabPanel value="caching" client:load>
```typescript
...
<TabPanel value="migration" client:load>
```typescript
...
<TabPanel value="replication" client:load>
```typescript
...
<div class="grid">
  <a href="/corpus/api/backends/memory/" class="card card-interactive">
    <div class="card-title">API: Memory Backend</div>
  </a>
  <a href="/corpus/api/backends/file/" class="card card-interactive">
    <div class="card-title">API: File Backend</div>
  </a>
  <a href="/corpus/api/backends/cloudflare/" class="card card-interactive">
    <div class="card-title">API: Cloudflare Backend</div>
  </a>
  <a href="/corpus/api/backends/layered/" class="card card-interactive">
    <div class="card-title">API: Layered Backend</div>
  </a>
</div>
