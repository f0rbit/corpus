...
- **Key facts** from research papers
- **Annotations** from user reviews
...
2. ### Create a corpus with observations
...
3. ### Store an article and extract observations
...
4. ### Query observations across all articles
...
5. ### Handle article updates automatically
...
<Tabs>
  <TabItem label="Option A: Delete and re-create">
    ```typescript
  ...
  <TabItem label="Option B: Let staleness handle it">
    ```typescript
