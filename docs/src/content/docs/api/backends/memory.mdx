...
<div class="grid">
  <div class="card">
    ...
    <div class="card-description">No I/O overhead, instant reads and writes</div>
  </div>
  <div class="card">
    <div class="card-title">Isolation</div>
    <div class="card-description">Each instance is completely independent</div>
  </div>
  <div class="card">
    <div class="card-title">Simplicity</div>
    <div class="card-description">No setup, no cleanup, no external dependencies</div>
  </div>
  <div class="card">
    <div class="card-title">Predictability</div>
    <div class="card-description">Deterministic behavior for testing</div>
  </div>
</div>
