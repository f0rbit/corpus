...
export const VersionSetManifestSchema = z.object({
  ...
  migrations: z.object({
    ...
    do_migrations: z.array(z.object({
      class_name: z.string(),
      tag: z.string(),
      kind: z.enum([
        'new_sqlite_classes',
...
type _AssertManifestShape = z.infer<typeof VersionSetManifestSchema> extends VersionSetManifest
 ...
 * ```
 */
export function version_set_store(
  backend: Backend,
  opts?: VersionSetStoreOptions
): VersionSetStore {
  ...
  async function promote_impl(
    ...
    return store.put(source.data, {
      ...
      parents: [
        { store_id: id, version: from_version, role: 'promoted_from' },
      ],
    })
  }
